...
breathe_projects = { "schmutz": "_doxygen/xml" }
breathe_default_project = "schmutz"
...
html_theme_options = {
    "project_nav_name": "schmutz",
    "github_link" : "https://github.com/arximboldi/schmutz",
}
...
latex_documents = [
    (master_doc, 'schmutz.tex', u'schmutz Documentation',
...
man_pages = [
    (master_doc, 'schmutz', u'schmutz Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'schmutz', u'schmutz Documentation',
     author, 'schmutz', 'One line description of project.',
     'Miscellaneous'),
]
